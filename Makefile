#############################################################################
# Makefile for building: AnaliseCPU
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  AnaliseCPU.pro
# Template: app
# Command: /home/peko/Qt5.5.1/5.5/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile AnaliseCPU.pro
#############################################################################
...
INCPATH       = -I. -I../../Qt5.5.1/5.5/gcc_64/include -I../../Qt5.5.1/5.5/gcc_64/include/QtCore -I. -I../../Qt5.5.1/5.5/gcc_64/mkspecs/linux-g++
QMAKE         = /home/peko/Qt5.5.1/5.5/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = AnaliseCPU1.0.0
DISTDIR = /home/peko/Dev/AnaliseCPU/.tmp/AnaliseCPU1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/peko/Qt5.5.1/5.5/gcc_64 -Wl,-rpath,/home/peko/Qt5.5.1/5.5/gcc_64/lib
LIBS          = $(SUBLIBS) -pthread -L/home/peko/Qt5.5.1/5.5/gcc_64/lib -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = ../../Qt5.5.1/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		AnaliseCPU.pro  main.cpp
QMAKE_TARGET  = AnaliseCPU
...
Makefile: AnaliseCPU.pro ../../Qt5.5.1/5.5/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt5.5.1/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt5.5.1/5.5/gcc_64/mkspecs/common/unix.conf \
		../../Qt5.5.1/5.5/gcc_64/mkspecs/common/linux.conf \
		../../Qt5.5.1/5.5/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt5.5.1/5.5/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../Qt5.5.1/5.5/gcc_64/mkspecs/features/lex.prf \
		AnaliseCPU.pro \
		/home/peko/Qt5.5.1/5.5/gcc_64/lib/libQt5Core.prl
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile AnaliseCPU.pro
...
main.o: main.cpp ../../Qt5.5.1/5.5/gcc_64/include/QtCore/QString \
